...
const DASH_DESC = "Mr Bands, the founder of bands.finance, makes markets on Meteora DLMM, Solana. He lays bands of liquidity around the price in the pools his screener ranks, tokenized stocks among them, earns the pool's fees when traders cross them, and publishes every move. His book today is paper: real pools, live prices, pretend money.";
