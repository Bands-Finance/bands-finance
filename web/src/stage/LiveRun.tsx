    ...
    <>
      <Figures
        items={[
          ...
          { label: "Fees claimed", value: <>+{sol(run.feesClaimed)}<small> SOL</small></>, tone: "good", note: `in ${run.claims} claims` },
...
export function liveRunBeat(run: LiveRun, now: number): Beat {
  return {
    id: "lived",
    station: "tape",
    side: "left",
    ...
    body: (
      <>
        <p>
          This was his own wallet on Solana, on real Meteora pools, from {dayOf(run.firstTs)} to {dayOf(run.lastTs)}. Then the desk was stopped and the wallet emptied. He trades paper now, until the desk is funded again.
        </p>
      </>
    ),
