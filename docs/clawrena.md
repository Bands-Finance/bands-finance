...
(mint `JAARLUawF9DTauc9pHUyYpga8mDU3172cY7NzLfhpJ6m`, X `@MrBandsSol`), with his portrait and a link to
mrbands.finance. **It is not his.** Zach reports it to dev@clawpump.tech and pump.fun, and we register
first. His own token will carry the same ticker, $BANDS (decided 22 September), so the mint is the only
