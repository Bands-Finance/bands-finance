...
- The copycat "Mr Bands" $BANDS (`JAARLU...pJ6m`, `@MrBandsSol`) is **not his**: report it, and register first.
...
1. **The copycat token and @MrBandsSol: not his.** Report both to ClawPump and pump.fun today, register first,
   and publish a not-his notice once his mint exists.
